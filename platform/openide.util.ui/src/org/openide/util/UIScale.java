...
/**
 * This class is copied form FlatLaf package. it handles scaling in Swing UIs.
 * It computes user scaling factor based on font size and provides methods to
 * scale integer, float, {@link Dimension} and {@link Insets}. This class is
...
public class UIScale {
    ...
    private static final String UI_SCALE_ENABLED = "flatlaf.uiScale.enabled";
    private static final String UI_SCALE = "flatlaf.uiScale";
    private static final String UI_SCALE_ALLOW_SCALE_DOWN = "flatlaf.uiScale.allowScaleDown";
    ...
    private static void updateScaleFactor() {
        ...
        Font font = null;
        final String laf = UIManager.getLookAndFeel().getClass().getName();
        if (laf.equals("com.formdev.flatlaf.FlatLaf") || laf.equals("com.formdev.flatlaf.FlatLightLaf")) {
    ...
    private static boolean getBoolean(String property, boolean defaultVal) {
        return Boolean.parseBoolean(System.getProperty(property)) || defaultVal;
    }
    ...
    private static float getCustomScaleFactor() {
        return parseScaleFactor(System.getProperty(UI_SCALE));
    }
    ...
    private static void setUserScaleFactor(float scaleFactor, boolean normalize) {
        if (normalize) {
            if (scaleFactor < 1f) {
                scaleFactor = getBoolean(UI_SCALE_ALLOW_SCALE_DOWN, false)
    ...
    /**
     * If user scale factor is not 1, scale the given graphics context by
     * invoking {@link Graphics2D#scale(double, double)} with user scale factor.
     */
